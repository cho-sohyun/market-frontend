...
const Signup = () => {
  ...
  const { userEmail, password, passwordCheck, name } = values;
  ...
  const isSubmitValid = password && passwordCheck && name;
  ...
  const signupSubmit = async (e) => {
    ...
    if (isSubmitValid && isEmailValid && isPasswordCheck) {
      try {
        const auth = getAuth();
    ...
    <div className={styles.signup}>
      <div className={styles.signupContainer}>
        ...
        <div className={styles.userFormContainer}>
          ...
          <button className={styles.duplicateButton} onClick={handleEmailCheck}>
        ...
        <div className={styles.signupSubmit}>
          <button className={styles.submitButton} onClick={signupSubmit}>
