...
const CategoryList = () => {
  ...
  const sortedProducts = sortProducts(categoriesAllProducts, selectedFilter);
  ...
  return (
    <div className={styles.categoryList}>
      <div className={styles.categoryListContainer}>
        <h2 className={styles.mainCategoryTitle}>{SUBCATEGORIES[0].mainCategoriesName}</h2>
        ...
        <div className={styles.productContainer}>
            ...
            <div className={styles.productList} key={product.productId}>
              <div className={styles.product}>
                ...
                <p className={styles.productDes}>{product.shortDescription}</p>
